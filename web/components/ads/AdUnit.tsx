...
export function AdUnit() {
  ...
  return (
    <aside aria-label="Advertisement" className="ad-unit">
      <div className="eyebrow">Advertisement</div>
      <ins
        ref={unit}
        className="adsbygoogle"
        data-ad-client="ca-pub-9961054735948902"
        data-ad-slot="4391479569"
        data-ad-format="auto"
      ...
      <Script
        id="b2-adsense"
        async
        src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9961054735948902"
