  ...
  return <main id="main" className={styles.explorer}>
    ...
    <section className={styles.search} aria-label="Ask and search the records">
      ...
      <form action="/search" className={styles.searchForm}>
        ...
        <div className={styles.searchRow}><input id="map-query" name="q" required placeholder="An address, substance, Bates number or question" autoComplete="off"/><button type="submit">Search →</button><button type="submit" formAction="/ask">Ask →</button></div>
      </form>
