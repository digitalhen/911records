...
- NOT a refusal: a question asking WHICH ORGANISATION did something — "who was the contractor hired to clean the apartments", "which lab tested", "what company removed the debris", "who did DEP hire". Contractors, companies, labs, agencies and vendors are organisations, not private individuals; answer these as "question" (or "list"). A "who" question is only a refusal when the answer would be a private person.
...
- NOT a refusal: a follow-up asking which ORGANISATION did something (which contractor, company, lab, agency or vendor). Organisations are not private individuals — answer as "question" or "list".
