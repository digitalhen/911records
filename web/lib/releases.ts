...
export const RELEASES: Release[] = [
  ...
  { version: '0.16.3', date: '2026-09-15', notes: ['Watch a video walkthrough of the records app at /demo.mp4.'] },
  {
    version: '0.16.2',
    date: '2026-09-15',
    notes: ['Connected AI tools can validate record results and pagination more reliably.'],
  },
  {
    version: '0.16.1',
    date: '2026-09-15',
    notes: ['Terms of Service are now available from the footer, covering the website and connected research tools.'],
  },
  {
    version: '0.16.0',
    date: '2026-09-15',
    notes: ['AI research tools can now connect to the records through MCP, search and browse the collection, read source pages with exact citations, and follow catalog changes.'],
  },
  {
    version: '0.15.2',
    date: '2026-09-15',
